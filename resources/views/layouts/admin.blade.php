            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="{{ route('admin.posts') }}"><i class="fa fa-files-o fa-fw"></i> Bài viết<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li><a href="{{ route('admin.posts') }}">List posts</a></li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li><a href="{{ route('admin.categories') }}">List categories</a></li>
                                <li><a href="{{ route('cat.create') }}">Create category</a></li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
